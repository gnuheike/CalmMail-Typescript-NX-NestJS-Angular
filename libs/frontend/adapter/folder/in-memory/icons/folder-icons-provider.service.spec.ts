...
import { FolderId } from '../../../../domain/folder/entity/folder.entity';

describe('FolderIconsProvider', () => {
    let service: StaticFolderIconsProviderAdapter;

    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [StaticFolderIconsProviderAdapter],
        });
        service = TestBed.inject(StaticFolderIconsProviderAdapter);
    });
