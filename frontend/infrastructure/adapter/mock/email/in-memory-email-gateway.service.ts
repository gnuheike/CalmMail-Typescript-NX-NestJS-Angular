...
export class InMemoryEmailGateway extends EmailGateway {
    ...
    private createInitialEmails(): Email[] {
        return [
            // Inbox emails
            this.createInboxEmail('clq1234567890email00000001', 'Welcome to CalmMail', 'support@calmmail.com', 
                'Thank you for choosing CalmMail. We hope you enjoy our calm and focused email experience.', false),
            this.createInboxEmail('clq1234567890email00000002', 'Meeting Tomorrow', 'manager@company.com', 
                "Let's meet tomorrow at 10 AM to discuss the project progress.", true, ['team@company.com']),
            this.createInboxEmail('clq1234567890email00000003', 'Vacation Plans', 'friend@personal.com', 
                'Hey, I was thinking about our vacation plans. How about we go to the beach next month?', false),

            // Sent emails
            this.createSentEmail('clq1234567890email00000004', 'Re: Project Update', 
                "I've completed the tasks you assigned. Please review and let me know if any changes are needed.", ['colleague@company.com']),
            this.createSentEmail('clq1234567890email00000005', 'Dinner Invitation', 
                'Would you like to join us for dinner this Saturday at 7 PM?', ['friend1@personal.com', 'friend2@personal.com']),

            // Draft emails
            this.createDraftEmail('clq1234567890email00000006', 'Project Proposal', 
                'Here is the project proposal we discussed. [DRAFT - NOT COMPLETE]', ['client@company.com']),

            // Work folder emails
            this.createWorkEmail('clq1234567890email00000007', 'Quarterly Report', 'finance@company.com', 
                'Please find attached the quarterly financial report.', false, ['team@company.com']),
            this.createWorkEmail('clq1234567890email00000008', 'New Project Opportunity', 'sales@company.com', 
                "We have a new project opportunity with a potential client. Let's discuss it in our next meeting.", true),

            // Family folder emails
            this.createFamilyEmail('clq1234567890email00000009', 'Family Reunion', 'relative@family.com', 
                "We're planning a family reunion next month. Please let me know if you can attend.", false, ['family@group.com']),
        ];
    }
